...
export class ApplyCodeBlockOperation {
	...
	private getNotebookEdits(codeBlock: ICodeMapperCodeBlock, chatSessionId: string | undefined, token: CancellationToken): AsyncIterable<TextEdit[] | ICellEditOperation[]> {
